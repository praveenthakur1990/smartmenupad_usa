    ...
    public class CustomerController : BaseController
    {
        ...
        public ActionResult Index(int page = 1, string searchStr = "")
        {
            using (var client = new HttpClient())
            {
                ...
                string url = apiBaseUrl + MethodEnum.GetCustomers.GetDescription().ToString() + "?customerId=0&userId=" + SessionManager.LoginResponse.UserId + "&pageNumber=" + page + "&pageSize=" + _pageSize + "&searchStr=" + searchStr;
